...
export default class ExtraButter {
  ...
  getIDForSize = async () => {
    const raffleInfoResponse = await this.rp({
      method: 'GET',
      uri: `https://rise45-draw.herokuapp.com/draws/${this.raffleDetails.product.product.id}`
    });
  ...
  createCustomer = () =>
    this.rp({
      method: 'POST',
      uri: 'https://rise45-draw.herokuapp.com/customers/new',
      form: {
  ...
  submitRaffle = (variant, customerID) => {
    ...
    return this.rp({
      method: 'POST',
      uri: 'https://rise45-draw.herokuapp.com/draws/entries/new',
      headers: {
  ...
  checkEmail = async () => {
    ...
    const validationEmailResponse = await this.rp({
      method: 'POST',
      url: 'https://rise45-draw.herokuapp.com/customers/validateEmail',
      headers: {
        accept: 'application/json, text/javascript, */*; q=0.01',
        referrer: this.url,
        Origin: 'https://crusoeandsons.com',
  ...
  login = async (email, pass) => {
    ...
    const loginResponse = await this.rp({
      method: 'POST',
      url: 'https://crusoeandsons.com/account/login',
      headers: {
        ...
        Accept: 'application/json, text/javascript, */*; q=0.01',
        Referer: 'https://crusoeandsons.com/account/login',
        Origin: 'https://crusoeandsons.com',
        'User-Agent':
          'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.131 Safari/537.36',
        'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
