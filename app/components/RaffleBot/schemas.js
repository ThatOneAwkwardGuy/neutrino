...
export const YMESchema = new Schema({
  deliveryFirstName: {
    type: String,
    required: true,
    message: {
...
export const RootedSchema = new Schema({
  email: {
    type: String,
    required: true,
    message: {
...
export const EighteenMontroseSchema = new Schema({
  email: {
    type: String,
    required: true,
    message: {
...
export const AFewStoreSchema = new Schema({
  email: {
    type: String,
    required: true,
    message: {
